...
string remove_0(string);	//將大數前幾位0去除 

int longer(int, int);		//比較何者較大int
...
int main(){
	...
	string p="389651984374348681198937829437632876251983672816323";
	string q="672838012783469248520967128763116286378291649376839";
	string n="262172666843572177835189692935490626681964526701551493375648501642796261483999546501062577067057342997";
	string e="723732698112534512672761745123638923636112736572367";
	string d="242853588675584071448128850816414130435448893272310264309100496716574692643023247001636249914195987867";
...
string O_divide_for_Remain(string divide_A, string divide_B){
	int length_A=divide_A.length(), length_B=divide_B.length(), interval=length_A-length_B;
	...
	for(int i=0;i<interval+1;i++){
		for(int j=1;j<10;j++){
			if(Is_A_Bigger_Than_B(str_remainder,divide_B)==1){
				...
				str_remainder+=str_temp.assign(divide_A,length_B+i,1);
	}		
